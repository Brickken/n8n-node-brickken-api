...
export class BrickkenApiV2 implements INodeType {
  description: INodeTypeDescription = {
    ...
    description:
      "Interact with Brickken API for tokenization and blockchain operations",
    defaults: {
      name: "Brickken API"
    },
    inputs: ["main"],
    ...
    properties: [
      ...
      // Common parameters
      {
        ...
        required: true,
        description:
          "Blockchain network to use. Production networks: Ethereum (1), Base (2105), BNB (38), Polygon (89). Sandbox networks: Sepolia (aa36a7), Polygon Amoy (13882)",
        routing: {
      ...
      },
      {
        ...
        displayOptions: {
          show: {
            resource: ["transactions"],
            operation: ["prepareTransactions"],
            method: ["newTokenization", "newSto", "approve", "closeOffer"]
          }
        }
      },
      {
        ...
        default: "",
        description:
          "URL to documentation or legal documents associated with the tokenization",
      ...
      },
      {
        ...
        required: true,
        description:
          'Full name of the token (e.g., "Real Estate Property Token")',
      ...
      },
      {
        ...
        default: "0",
        description:
          "Maximum number of tokens that can be minted (leave empty for unlimited supply)",
      ...
      },
      {
        ...
        required: true,
        description:
          "Accepted payment coin (e.g., USDT, USDC, or NATIVE for chain native coin)",
      ...
      // Fields for newTokenization method
      {
        ...
        typeOptions: {
          multipleValues: true,
          multipleValueButtonText: "Add PreMint"
        },
        default: {},
        description:
          "Pre-mint tokens to specific addresses during tokenization",
        options: [
          {
            displayName: "Amount",
            name: "amount",
      ...
      },
      {
        ...
        typeOptions: {
          multipleValues: true,
          multipleValueButtonText: "Add Holder"
        },
        default: {},
      ...
      },
      {
        ...
        options: [
          ...
          {
            displayName: "Need KYC",
            name: "needKyc",
            type: "boolean",
            default: false
          },
          {
            displayName: "Need Whitelist",
            name: "needWhitelist",
            type: "boolean",
            default: false
          },
      ...
      // Patch Token Docs parameters
      {
        ...
        routing: { send: { type: "body", property: "tokenSymbol" } },
        displayOptions: {
          show: { resource: ["transactions"], operation: ["patchTokenDocs"] }
        }
      },
      {
      ...
      },
      {
        ...
        default: "",
        description:
          "Name of the binary property containing the subscription agreement PDF",
        routing: {
          send: {
            type: "body",
      ...
      },
      {
        ...
        default: "",
        description:
          "Name of the binary property containing the legal documents PDF",
        routing: {
          send: {
            type: "body",
            property: "legalDocs"
      ...
      // Info resource operations
      {
        ...
        options: [
          ...
          },
          {
            ...
            routing: {
              request: { method: "GET", url: "/get-balance-whitelist" }
            }
          },
          {
            ...
            routing: {
              request: { method: "GET", url: "/get-dividend-distribution" }
            }
          },
          {
            ...
            routing: {
              request: { method: "GET", url: "/get-investments-by-sto-id" }
            }
          },
          {
          ...
          },
          {
            ...
            routing: {
              request: { method: "GET", url: "/get-transaction-status" }
            }
          },
          {
            ...
            routing: {
              request: { method: "GET", url: "/get-whitelist-status" }
            }
          }
        ],
      ...
      // Get Transaction Status parameters
      {
        ...
        displayOptions: {
          show: { resource: ["info"], operation: ["getTransactionStatus"] }
        }
      },
      ...
      // Get Balance & Whitelist - investorEmail parameter
      {
        ...
        displayOptions: {
          show: { resource: ["info"], operation: ["getBalanceWhitelist"] }
        }
      },
      ...
      // Get Allowance - spenderAddress parameter
      {
        ...
        displayOptions: {
          show: { resource: ["info"], operation: ["getAllowance"] }
        }
      },
      ...
      // Get Whitelist Status - investorAddress parameter
      {
        ...
        displayOptions: {
          show: { resource: ["info"], operation: ["getWhitelistStatus"] }
        }
      },
      ...
      // Get Investor Info - email parameter
      {
        ...
        displayOptions: {
          show: { resource: ["info"], operation: ["getInvestorInfo"] }
        }
      }
