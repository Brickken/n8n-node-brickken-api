# n8n-nodes-brickken-api

[![npm version](https://badge.fury.io/js/n8n-nodes-brickken-api.svg)](https://badge.fury.io/js/n8n-nodes-brickken-api)
...
2. Select **Install**
3. Enter `n8n-nodes-brickken-api`
4. Click **Install**

### Manual Installation

```bash
npm install n8n-nodes-brickken-api
```
